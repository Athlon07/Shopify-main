...
const authRoutes = require('./services/auth'); // <-- added auth routes
...
// Auth Routes
// --------------------
app.use('/api/auth', authRoutes); // <-- mounts your auth.js
...
// --------------------
// Admin Webhook Secret Route
// --------------------
app.post('/admin/tenant-secret', async (req, res) => {
...
app.listen(PORT, () => {
  ...
  console.log(`🛡️  Auth endpoints: http://localhost:${PORT}/api/auth`);
});
